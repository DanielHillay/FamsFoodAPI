...
public class FoodAnalysis {
    ...
    public List<ItemsToPrepare> getMealsToMakePerMealTime(String weekDay, String mealTime){
        ...
        AdminUser adminUser = adminRepository.findByUserName(authentication.getName()).get();
        Long town = adminUser.getTownId();

        List<ItemsToPrepare> itemsToPrepare = new ArrayList<>();

        List<FeedingScheme> schemeDay = schemeRepo.findByWeekDayAndTownId(weekDay, town);
    ...
    public List<ItemsToPrepare> getMealsToMakePerMealTimeByTown(String weekDay, String mealTime){
        List<StoreFoodItem> item = storeFoodItemRepo.findAll();
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        AdminUser adminUser = adminRepository.findByUserName(authentication.getName()).get();
        Long town = adminUser.getTownId();
    ...
    public List<ItemsToPrepare> getMealsToMakePerMealTimeByLGA(String weekDay, String mealTime){
        List<StoreFoodItem> item = storeFoodItemRepo.findAll();
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        AdminUser adminUser = adminRepository.findByUserName(authentication.getName()).get();
        String LGA = adminUser.getLGA();

        List<ItemsToPrepare> itemsToPrepare = new ArrayList<>();

        List<FeedingScheme> schemeDay = schemeRepo.findByWeekDayAndLGA(weekDay, LGA);
        List<String> mealIds = new ArrayList<>();
        List<FoodItems> rice = new ArrayList<>();
        List<FoodItems> beans = new ArrayList<>();
        List<FoodItems> beef = new ArrayList<>();
    ...
    public List<ItemsToPrepare> getMealsToMakePerMealTimeByState(String weekDay, String mealTime){
        List<StoreFoodItem> item = storeFoodItemRepo.findAll();
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        AdminUser adminUser = adminRepository.findByUserName(authentication.getName()).get();
        ...
        List<FeedingScheme> schemeDay = schemeRepo.findByWeekDayAndState(weekDay, state);
        List<String> mealIds = new ArrayList<>();
        List<FoodItems> rice = new ArrayList<>();
        List<FoodItems> beans = new ArrayList<>();
        List<FoodItems> beef = new ArrayList<>();
    ...
    public List<ItemsToPrepare> getMealsToMakePerMealTimeByCountry(String weekDay, String mealTime){
        List<StoreFoodItem> item = storeFoodItemRepo.findAll();
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        AdminUser adminUser = adminRepository.findByUserName(authentication.getName()).get();
        ...
        List<FeedingScheme> schemeDay = schemeRepo.findByWeekDayAndCountry(weekDay, country);
        List<String> mealIds = new ArrayList<>();
        List<FoodItems> rice = new ArrayList<>();
        List<FoodItems> beans = new ArrayList<>();
        List<FoodItems> beef = new ArrayList<>();
